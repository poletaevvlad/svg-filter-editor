  ...
  render() {
    return (
      <div className="color-picker">
        <div className="saturation" onMouseDown={focused}>
          <Saturation {...this.props} onChange={this.props.onChange} />
        </div>
        <div className="hue" onMouseDown={focused}>
          <Hue
            {...this.props}
        ...
        <div className="rgb horizontal compact">
          ...
          <TextInput
            ...
            onChange={this._redChanged}
            validator={validators.isColorComponent}
          />
          <TextInput
            className="field"
            value={this.props.rgb.g}
            onChange={this._greenChanged}
            validator={validators.isColorComponent}
          />
          <TextInput
            className="field"
            value={this.props.rgb.b}
            onChange={this._blueChanged}
            validator={validators.isColorComponent}
          />
        </div>
        <div className="hex horizontal compact">
          ...
          <TextInput
            className="field"
            value={this.props.hex.substr(1)}
            onChange={this._hexChanged}
