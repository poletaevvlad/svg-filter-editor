    ...
    return (
      <div className="vertical">
        <div className="horizontal">
          ...
          <TextInput
            className="field"
            value={this.props.primitive.orderX}
            onChange={this.valSetter("orderX")}
            validator={validators.isPositiveInteger}
            converter={converters.int}
          />
          <TextInput
            className="field"
            value={this.props.primitive.orderY}
            onChange={this.valSetter("orderY")}
            validator={validators.isPositiveInteger}
            converter={converters.int}
          />
        </div>
        {arrayRange(0, this.props.primitive.orderY).map((i) => (
          <div className="horizontal" key={i}>
            {arrayRange(0, this.props.primitive.orderX).map((j) => (
              <TextInput
                className="field"
                value={this.props.primitive.kernelMatrix[i][j]}
        ...
        <div className="horizontal">
          ...
          <ReactSlider
            max={this.props.primitive.orderX - 1}
            value={this.props.primitive.targetX}
            onChange={this.valSetter("targetX")}
          />
          <TextInput
            value={this.props.primitive.targetX}
            onChange={this.valSetter("targetX")}
        ...
        <div className="horizontal">
          ...
          <ReactSlider
            max={this.props.primitive.orderY - 1}
            value={this.props.primitive.targetY}
            onChange={this.valSetter("targetY")}
          />
          <TextInput
            value={this.props.primitive.targetY}
            onChange={this.valSetter("targetY")}
        ...
        <Hidable name="Details">
          <div className="vertical">
            <div className="horizontal align-middle">
              <CheckBox
                checked={this.props.primitive.divisorActive}
                onChange={(e) =>
                  this.valSetter("divisorActive")(e.target.checked)
                }
              />
              <div className="label">divisor:</div>
              <TextInput
                value={this.props.primitive.divisor}
                onChange={this.valSetter("divisor")}
                enabled={this.props.primitive.divisorActive}
                validator={validators.isNumber}
                converter={converters.float}
              />
            </div>
            ...
            <div className="horizontal">
              ...
              <TextInput
                value={this.props.primitive.bias}
                onChange={this.valSetter("bias")}
                validator={validators.isNumber}
                converter={converters.float}
              />
            </div>
            ...
            <ComboBox
              value={this.props.primitive.edgeMode}
              width={this.props.primitive.nodeWidth - 18}
              values={this.props.primitive.edgeModes.map((op) => {
                return { value: op, label: op };
              })}
              label="edge mode:"
              onChange={this.valSetter("edgeMode")}
            />

            <label className="horizontal align-middle">
              <CheckBox
                checked={this.props.primitive.preserveAlpha}
                onChange={(e) =>
                  this.valSetter("preserveAlpha")(e.target.checked)
                }
              />
