  ...
  renderEditor() {
    return (
      <div className="vertical">
        <ColorPicker
          color={this.props.primitive.color}
          onChange={(val) => this.valSetter("color")(val.hex)}
        />
        <div className="horizontal">
          <div className="label">&alpha;:</div>
          <ReactSlider
            max={1000}
            value={this.props.primitive.alpha * 1000}
            onChange={(e) => this.valSetter("alpha")(e / 1000)}
          />
          <TextInput
            className="field"
            value={this.props.primitive.alpha}
            onChange={this.valSetter("alpha")}
