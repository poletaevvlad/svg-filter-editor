...
class GaussianBlurNode extends Node{
	...
	renderEditor(){
		return <div className="horizontal">
			...
			<TextInput className="field" value={this.props.primitive.stdDeviation} onChange={this.valSetter("stdDeviation")} validator={validators.isPositiveNumber} converter={converters.float} />
		</div>
	}
}
