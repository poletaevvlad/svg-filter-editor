...
class Turbulence extends Primitive {
  ...
  getSVG() {
    return this.svgTag("feTurbulence")
      ...
      .arg(
        "baseFrequency",
        `${this.baseFrequencyX} ${this.baseFrequencyY}`,
        "0 0"
      )
  ...
  renderEditor() {
    return (
      <div className="vertical">
        <ComboBox
          value={this.props.primitive.type}
          width={this.props.primitive.nodeWidth - 18}
          values={this.props.primitive.types.map((type) => {
        ...
        <div className="horizontal">
          ...
          <TextInput
            className="field"
            value={this.props.primitive.baseFrequencyX}
            converter={converters.float}
            onChange={this.valSetter("baseFrequencyX")}
            validator={validators.isPositiveNumber}
          />
          <TextInput
            className="field"
            value={this.props.primitive.baseFrequencyY}
            converter={converters.float}
            onChange={this.valSetter("baseFrequencyY")}
            validator={validators.isPositiveNumber}
          />
        </div>
        ...
        <div className="horizontal">
          ...
          <TextInput
            className="field"
            value={this.props.primitive.numOctaves}
            converter={converters.int}
            onChange={this.valSetter("numOctaves")}
        ...
        <div className="horizontal">
          ...
          <TextInput
            className="field"
            value={this.props.primitive.seed}
            converter={converters.int}
            onChange={this.valSetter("seed")}
            validator={validators.isPositiveInteger}
          />
        </div>
        ...
        <label className="horizontal align-middle">
          <CheckBox
            checked={this.props.primitive.stitchTiles}
